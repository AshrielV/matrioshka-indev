...
declare namespace Registry {
    ...
    class ItemSource extends Internal.RegistryEventJS<any> {
    }
    class TrackedEntryType extends Internal.RegistryEventJS<any> {
    }
    class GolemType extends Internal.RegistryEventJS<any> {
    }
    class Modifier extends Internal.RegistryEventJS<any> {
    }
    class StatType extends Internal.RegistryEventJS<any> {
    }
    class Badge extends Internal.RegistryEventJS<any> {
    }
    class Contaminant extends Internal.RegistryEventJS<any> {
    }
    class Dough extends Internal.RegistryEventJS<any> {
    }
    class DoughCut extends Internal.RegistryEventJS<any> {
    }
    class IngredientModifierType extends Internal.RegistryEventJS<any> {
    }
    class IngredientRandomizerType extends Internal.RegistryEventJS<any> {
    }
    class LootEntityNumberProviderType extends Internal.RegistryEventJS<any> {
    }
    class LootItemStackNumberProviderType extends Internal.RegistryEventJS<any> {
    }
    class LootTeamNumberProviderType extends Internal.RegistryEventJS<any> {
    }
    class RewardGeneratorType extends Internal.RegistryEventJS<any> {
    }
    class RewardType extends Internal.RegistryEventJS<any> {
    }
    class Shop extends Internal.RegistryEventJS<any> {
    }
    class ShopOfferGenerator extends Internal.RegistryEventJS<any> {
    }
    class TeamDataType extends Internal.RegistryEventJS<any> {
    }
    class TeamType extends Internal.RegistryEventJS<any> {
    }
