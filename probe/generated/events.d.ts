...
tags(type: "dimension", handler: (event: TagEvent.Dimension) => void): void
tags(type: "minecraft:dimension", handler: (event: TagEvent.Dimension) => void): void
    /**
     * @at *server*
    */
...
declare const EmiPlusPlusEvents: {
    /**
     * @at *client*
    */
registerGroups(handler: (event: Internal.RegisterStackGroupsEventJS) => void):void,
};
...
registry(type: "modulargolems:golem_type", handler: (event: Registry.GolemType) => void):void,
registry(type: "modulargolems:modifier", handler: (event: Registry.Modifier) => void):void,
registry(type: "modulargolems:stat_type", handler: (event: Registry.StatType) => void):void,
registry(type: "petrolpark:badge", handler: (event: Registry.Badge) => void):void,
registry(type: "petrolpark:contaminant", handler: (event: Registry.Contaminant) => void):void,
registry(type: "petrolpark:dough", handler: (event: Registry.Dough) => void):void,
registry(type: "petrolpark:dough_cut", handler: (event: Registry.DoughCut) => void):void,
registry(type: "petrolpark:ingredient_modifier_type", handler: (event: Registry.IngredientModifierType) => void):void,
registry(type: "petrolpark:ingredient_randomizer_type", handler: (event: Registry.IngredientRandomizerType) => void):void,
registry(type: "petrolpark:loot_entity_number_provider_type", handler: (event: Registry.LootEntityNumberProviderType) => void):void,
registry(type: "petrolpark:loot_item_stack_number_provider_type", handler: (event: Registry.LootItemStackNumberProviderType) => void):void,
registry(type: "petrolpark:loot_team_number_provider_type", handler: (event: Registry.LootTeamNumberProviderType) => void):void,
registry(type: "petrolpark:reward_generator_type", handler: (event: Registry.RewardGeneratorType) => void):void,
registry(type: "petrolpark:reward_type", handler: (event: Registry.RewardType) => void):void,
registry(type: "petrolpark:shop", handler: (event: Registry.Shop) => void):void,
registry(type: "petrolpark:shop_offer_generator", handler: (event: Registry.ShopOfferGenerator) => void):void,
registry(type: "petrolpark:team_data_type", handler: (event: Registry.TeamDataType) => void):void,
registry(type: "petrolpark:team_type", handler: (event: Registry.TeamType) => void):void,
